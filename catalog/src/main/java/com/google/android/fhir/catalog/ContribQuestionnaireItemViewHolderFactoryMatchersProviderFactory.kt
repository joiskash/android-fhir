...
import com.google.android.fhir.datacapture.contrib.views.PasswordViewHolderFactory
...
object ContribQuestionnaireItemViewHolderFactoryMatchersProviderFactory :
  ...
  override fun get(
    ...
    when (provider) {
      ...
      PASSWORD_WIDGET_PROVIDER ->object : QuestionnaireFragment.QuestionnaireItemViewHolderFactoryMatchersProvider() {
        override fun get():
          List<QuestionnaireFragment.QuestionnaireItemViewHolderFactoryMatcher> {
          return listOf(
            QuestionnaireFragment.QuestionnaireItemViewHolderFactoryMatcher(

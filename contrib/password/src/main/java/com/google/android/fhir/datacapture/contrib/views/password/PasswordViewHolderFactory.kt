...
object PasswordViewHolderFactory :
  QuestionnaireItemViewHolderFactory(
    com.google.android.fhir.datacapture.contrib.views.password.R.layout.password_view,
  ) {
    ...
    object : QuestionnaireItemViewHolderDelegate {
      ...
      override fun init(itemView: View) {
        ...
        passwordInputLayout =
          itemView.findViewById(
            com.google.android.fhir.datacapture.contrib.views.password.R.id
      ...
      private fun displayValidationResult(validationResult: ValidationResult) {
        passwordInputLayout.error =
          getValidationErrorMessage(passwordInputLayout.context, questionnaireViewItem, validationResult)
      }
